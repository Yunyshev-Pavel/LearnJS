...
// Задача 1: Использование символов в объектах
// Создай объект, который содержит несколько свойств,
// одно из которых должно быть символом.
// Используя символ, добавь метод, который выводит все свойства объекта, включая символ.
// Выведи свойства объекта в консоль.
...
// Задача 2: Проверка на наличие символа в объекте
// Создай функцию, которая принимает объект и символ.
// Функция должна проверять,
// существует ли символ в переданном объекте, и возвращать true или false
